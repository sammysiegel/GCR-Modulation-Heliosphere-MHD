...
//----------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   simulation->MainLoop();
   simulation->PrintDistro1D(0, 0, "output_april26/modulated_gcr_spectrum_SSSW_fixednewKdriftsNLGC_3au.dat", true);
   simulation->PrintDistro1D(1, 0, "output_april26/time_gcr_trajec_SSSW_fixednewKdriftsNLGC_3au.dat", true);
