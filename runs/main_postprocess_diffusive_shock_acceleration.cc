...
const double r_TS = 0.118*one_au;
...
const double t_final = 3.0 * one_day;
const double z_spectrum = 1.25*r_TS;
const double p0 = Mom(0.1 * one_MeV, specie);
const double pf = Mom(10.0 * one_MeV, specie);
const double s = 4.0;
const double U_up = 4.0e7 / unit_velocity_fluid;
const double U_dn = U_up / s;
const double DeltaU = U_up - U_dn;
const double kappa_up = 1.0e17 / unit_diffusion_fluid;
...
// Spectrum vs momentum
   infilename = "collapsed_tsTrajectoryParkerSource_spectrum.dat";
   outfilename = "collapsed_tsTrajectoryParkerSource_spectrum_pp.dat";
